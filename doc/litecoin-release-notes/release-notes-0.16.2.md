Mkscoin Core version 0.16.2 is now available from:

  <https://download.Mkscoin.org/Mkscoin-0.16.2/>
...
- #12843 `df38b13` Test starting mkscoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure mkscoind processes are cleaned up when tests end (sdaftuar)
...
- #13797 `6518bcd` mkscoinconsensus: invalid flags should be set to mkscoinconsensus_error type, add test cases covering mkscoinconsensus error codes (Thomas Kerin)
