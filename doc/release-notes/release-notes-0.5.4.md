mkscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/mkscoin/files/mkscoin/mkscoin-0.5.4/
...
http://gitorious.org/mkscoin/mkscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix mkscoin-Qt notifications under Growl 1.3.
Increase required age of mkscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxmkscoin properly when installing mkscoin-Qt over it. (Windows)
