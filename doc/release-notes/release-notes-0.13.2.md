mkscoin Core version 0.13.2 is now available from:
  ...
  <https://mkscoin.org/bin/mkscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update mkscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow mkscoin-tx to create v2 transactions (btcdrak)
