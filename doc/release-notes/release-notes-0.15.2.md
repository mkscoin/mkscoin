mkscoin Core version *0.15.2* is now available from:

  <https://mkscoincore.org/bin/mkscoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in mkscoin-tx (TheBlueMatt)
