mkscoin Core version 0.17.0 is now available from:

  <https://mkscoincore.org/bin/mkscoin-core-0.17.0/>
...
To receive security and update notifications, please subscribe to:
  ...
  <https://mkscoincore.org/en/list/announcements/join/>
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/mkscoin/).
