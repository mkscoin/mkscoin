mkscoin Core version 0.10.4 is now available from:

  <https://mkscoin.org/bin/mkscoin-core-0.10.4/>
...
- #6953 `43c2789` Split mkscoin-tx into its own package
- #6953 `dfe0d4d` Include mkscoin-tx binary on Debian/Ubuntu
