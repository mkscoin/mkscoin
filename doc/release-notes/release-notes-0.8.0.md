mkscoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/mkscoin/files/mkscoin/mkscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the mkscoin
...
New/changed settings (command-line or mkscoin.conf file)
--------------------------------------------------------
