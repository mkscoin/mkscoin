mkscoin Core version 0.9.4 is now available from:

  https://mkscoin.org/bin/0.9.4/
...
this update is incompatible with the mkscoin system and could lead to consensus
forks.

mkscoin Core released binaries from https://mkscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~mkscoin/+archive/ubuntu/mkscoin
- A third-party or self-compiled mkscoin Core

upgrade to mkscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
