...
"""Verify that starting Mkscoin with -h works as expected."""

from test_framework.test_framework import mkscoinTestFramework
from test_framework.util import assert_equal

class HelpTest(mkscoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Mkscoin with -h for help text")
        ...
        self.log.info("Start Mkscoin with -version for version information")
        ...
        self.log.info("Start Mkscoind with -fakearg to make sure it does not start")
