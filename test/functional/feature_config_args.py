...
class ConfArgsTest(mkscoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'Mkscoin.conf'), 'a', encoding='utf-8') as conf:
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "Mkscoin.conf")
        ...
        # Temporarily disabled, because this test would access the user's home dir (~/.mkscoin)
