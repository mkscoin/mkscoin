...
# Copyright (c) 2010-2018 The mkscoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""mkscoin test framework primitive and message structures
...
# Objects that map to mkscoind objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in mkscoind
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class CBlockHeader:
    ...
    def calc_sha256(self):
        if self.sha256 is None:
            ...
            self.scrypt256 = uint256_from_str(Mkscoin_scrypt.getPoWHash(r))
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in mkscoind indicates these should be deserialized as blocks
