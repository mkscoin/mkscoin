...
# TestP2PConn: A peer we use to send messages to mkscoind, and store responses.
...
class CompactBlocksTest(mkscoinTestFramework):
    ...
    # This test actually causes mkscoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that mkscoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for mkscoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # mkscoind will not send blocktxn responses for blocks whose height is
