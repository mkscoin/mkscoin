...
static void SetupmkscoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " Mkscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  Mkscoin-tx [options] <hex-tx> [commands]  Update hex-encoded Mkscoin transaction\n" +
            "or:     Mkscoin-tx [options] -create [commands]   Create hex-encoded Mkscoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mkscoin transaction
