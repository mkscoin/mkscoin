...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.Mkscoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.Mkscointools.com");
        vSeeds.emplace_back("dnsseed.Mkscoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.Mkscointools.com");
        vSeeds.emplace_back("seed-b.Mkscoin.loshan.co.uk");
