...
#ifndef mkscoin_TEST_SCRIPTNUM10_H
#define mkscoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from mkscoin Core 0.10.0, for cross-comparison.
 */
public:
