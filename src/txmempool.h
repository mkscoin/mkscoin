...
#ifndef mkscoin_TXMEMPOOL_H
#define mkscoin_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/mkscoin/mkscoin/pull/14193 will fix it. No known code
     * in mkscoin currently depends on second guarantee, but it is important to
