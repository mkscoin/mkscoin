    ...
    platformStyle(_platformStyle)
{
    ...
    // normal mkscoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying mkscoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &mkscoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
