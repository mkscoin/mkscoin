    ...
    mapper(nullptr)
{
    ...
    ui->mkscoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->mkscoinAtStartup);
    ...
    ui->mkscoinAtStartup->setToolTip(ui->mkscoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->mkscoinAtStartup->setText(ui->mkscoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openmkscoinConfButton->setToolTip(ui->openmkscoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new mkscoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->mkscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openmkscoinConfButton_clicked()
{
