...
//! Entry point for mkscoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &mkscoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for mkscoinGUI tests.
void AppTests::guiTests(mkscoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &mkscoinGUI::consoleShown, this, &AppTests::consoleTests);
