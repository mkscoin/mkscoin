...
#ifndef mkscoin_QT_mkscoinUNITS_H
#define mkscoin_QT_mkscoinUNITS_H
...
/** mkscoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class mkscoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit mkscoinUnits(QObject *parent);

    /** mkscoin units.
      @note Source: https://en.mkscoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef mkscoinUnits::Unit mkscoinUnit;

#endif // mkscoin_QT_mkscoinUNITS_H
