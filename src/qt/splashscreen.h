...
#ifndef mkscoin_QT_SPLASHSCREEN_H
#define mkscoin_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. mkscoin Core initialization
...
#endif // mkscoin_QT_SPLASHSCREEN_H
