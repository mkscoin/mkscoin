 ...
 */
#ifndef mkscoin_UTIL_SYSTEM_H
#define mkscoin_UTIL_SYSTEM_H
...
extern const char * const mkscoin_CONF_FILENAME;
...
{
    std::string s = strprintf("Mkscoin-%s", name);
