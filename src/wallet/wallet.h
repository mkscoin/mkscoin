...
#ifndef mkscoin_WALLET_WALLET_H
#define mkscoin_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! mkscoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this mkscoin node, and set to 0 for transactions that were created
