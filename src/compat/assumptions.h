...
#ifndef mkscoin_COMPAT_ASSUMPTIONS_H
#define mkscoin_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Mkscoin cannot be compiled without assertions."
#endif
...
#endif // mkscoin_COMPAT_ASSUMPTIONS_H
